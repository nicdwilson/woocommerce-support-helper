...
class Blueprint_Exporter {
	/**
	 * Private plugin exporter instance.
	 *
	 ...
	 *
	 * @param string $name The name of the exporter to retrieve.
	 * @return Abstract_Exporter|null The exporter object or null if not found.
	 */
	 ...
	 *
	 * @param Abstract_Exporter $exporter The exporter to register.
	 */
	 ...
	 *
	 * This method replaces the default WooCommerce Blueprint REST API with our custom
	 * version that uses our custom ExportSchema.
	 */
