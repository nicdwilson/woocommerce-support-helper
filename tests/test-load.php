...
try {
    ...
    $private_plugin_exporter = new \WooCommerceSupportHelper\Private_Plugin_Exporter();
...
echo "Logger class exists: " . (class_exists('\WooCommerceSupportHelper\Logger') ? 'Yes' : 'No') . "\n";
echo "Abstract_Exporter class exists: " . (class_exists('\WooCommerceSupportHelper\Abstract_Exporter') ? 'Yes' : 'No') . "\n";
echo "Private_Plugin_Exporter class exists: " . (class_exists('\WooCommerceSupportHelper\Private_Plugin_Exporter') ? 'Yes' : 'No') . "\n"; 